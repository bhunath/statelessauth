...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public HttpCookieOAuth2AuthorizationRequestRepository(int expireCookie) {

        cookieExpirySecs = expireCookie / 1000;
    }
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request,
        ...
        if (authorizationRequest == null) {
            ...
            deleteCookies(request, response, AUTHORIZATION_REQUEST_COOKIE_NAME, REDIRECT_URI);
            return;
        }
        ...
        String lemonRedirectUri = request.getParameter(REDIRECT_URI);
        if (StringUtils.isNotBlank(lemonRedirectUri)) {

            cookie = new Cookie(REDIRECT_URI, lemonRedirectUri);
            cookie.setPath("/");
            cookie.setHttpOnly(true);
            cookie.setMaxAge(cookieExpirySecs);
            //cookie.setSecure(true);
